...
public:
	...
	bool printDataNode(string item, int min_frequency);
	bool printRange(string item, int min_frequency, int max_frequency);
	bool printConfidence(string item, double rate);
};
